...
class MultiHumanRL(CADRL):
    ...
    def predict(self, state):
        ...
        if self.phase == 'train' and probability < self.epsilon:
            ...
            action_states = [self.compute_action_vals_activs(action, state) for action in self.action_space]
            ...
            for i in range(len(action_order)) :
                ...
                action_value = reward + pow(self.gamma, self.time_step * state.self_state.v_pref) * value
