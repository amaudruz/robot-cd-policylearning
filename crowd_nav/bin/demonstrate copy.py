...
def main():
    ...
    explorer = ExplorerDs(env, robot, device, args.num_frames, memory, gamma=gamma, target_policy=policy)
    ...
    human_obsv = explorer.run_k_episodes(il_episodes, 'train', update_memory=True, imitation_learning=True, noise_explore=noise_explore, print_info=True)
